window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		var Market_module_css_default = {
			...
			"hostRequirementOk": "nUhMVa_hostRequirementOk",
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: compatibility?.status === "compatible" ? Market_module_css_default.hostRequirementOk : compatibility?.status === "incompatible" ? Market_module_css_default.hostRequirementBad : Market_module_css_default.hostRequirement,
